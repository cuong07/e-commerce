...
export const banners = [
  {
    ...
    description:"Explore Veles, the graphene-enhanced technical layer for Autumn/Winter pursuits.",
    image: image_1,
    pos: "center",
    action: [
      {
  ...
  },
  {
    ...
    description:"Ithax - our newest range of insulated jackets and gilets to be carried  <br /> everywhere from alpine faces to remote places.",
    image: image_2,
    pos: "center",
    action: [
      {
  ...
  },
  {
    ...
    description:"Discover reliable winter staples from performance fleeces to award-winning mid layers.",
    image: image_3,
    pos: "end",
    action: [
      {
