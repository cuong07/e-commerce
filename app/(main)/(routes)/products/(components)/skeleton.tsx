...
const Skeleton = ({ numberElement }: { numberElement: number }) => {
    return (
        <ul className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-2 sm:gap-x-6 md:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
            {[...Array(numberElement)].map((movie, index) => (
