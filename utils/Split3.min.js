...
!(function (D, u) {
    ...
    function C(D, u, e, F, C, i, n) {
        var E,
            ...
            J = ~(I || '').indexOf('++'),
            K = [];
        for (J && (I = I.split('++').join('')), r = (s = D.getElementsByTagName('*')).length, l = [], E = 0; E < r; E++)
            l[E] = s[E];
        if (k || G)
            for (E = 0; E < r; E++)
                ((d = (o = l[E]).parentNode === D) || G || (q && !P)) &&
                    ((m = o.offsetTop),
                    k && d && Math.abs(m - S) > L && ('BR' !== o.nodeName || 0 === E) && ((a = []), k.push(a), (S = m)),
        ...
        G &&
            ...
            i > D.clientWidth && ((D.style.width = i - N + 'px'), D.clientWidth < i && (D.style.width = i + _ + 'px'))),
            y(e, W),
            P && y(F, H),
            y(C, V);
    }
    ...
    function D(D, e, F, C) {
        ...
        for (
            ...
            if (((o = i.charAt(E)), g && (d = g(i.substr(E), e.specialChars))))
                (o = i.substr(E, d || 1)), (n += p && ' ' !== o ? C() + o + '</' + a + '>' : o), (E += d - 1);
