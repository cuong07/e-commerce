                ...
                <SwiperSlide key={banner.titile}>
                    <div className="relative h-full ">
                        <div className="absolute left-0 top-0">
                            <Image src={banner.image} alt={banner.titile} className="w-full h-full object-cover" />
                        </div>
                        ...
                        >
                            {activeIndex === index && (
                                <TextTyping className="md:text-3xl font-light text-white" text={banner.titile} />
                            )}
                            {activeIndex !== index && (
                                <span className="md:text-4xl font-light text-white">{banner.titile}</span>
                            )}
                            ...
                            {activeIndex !== index && (
                                <span className="md:text-base text-white font-extralight ">{banner.description}</span>
                            )}
